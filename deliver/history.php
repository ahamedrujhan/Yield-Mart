...
<input type="text" placeholder="Search Here" name="filter_search"/>
...
$value_filter=$_POST['filter_search'];
$query="SELECT * FROM `order` WHERE CONCAT(name,number,address) LIKE '%$value_filter'";
...
if(mysqli_num_rows($query_run)>0){
    ...
    while($row=mysqli_fetch_assoc($query_run)){
     ?>  
        ...
        <td class='text-left'><?php echo $row['total_products'] ?>   </td>
        <td class='text-left'><?php echo $row['total_price'] ?>  </td>
        <td class='text-left'><?php echo $row['total_price'] ?>   </td>
        </tr>
