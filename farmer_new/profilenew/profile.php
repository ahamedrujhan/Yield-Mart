		...
		<div class="row col-lg-8 border rounded mx-auto mt-5 p-2 shadow-lg">
			...
			<div class="col-md-8">
				...
				<table class="table table-striped"><br><br>
					...
					<tr ><th style="padding:5px"><i class="bi bi-envelope"></i> Email</th><td><?=esc($row['email'])?></td></tr>
					...
					<tr><th><i class="bi bi-house-door-fill"></i> Address</th><td><?=esc($row['address'])?></td></tr>
					<tr><th><i class="bi bi-telephone"></i> Phone Number</th><td><?=esc($row['phone'])?></td></tr>
